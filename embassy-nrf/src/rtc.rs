...
/// Compare register is not implemented for RTC0.
#[derive(Debug, PartialEq, Eq)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub struct CompareRegNotImplementedError;
...
/// nRF RTC driver.
///
/// If the `time-driver-rtc1` feature is enabled, the creation of a driver with RTC1 will conflict
/// with the time driver implementation.
...
impl<'d, T: Instance> Rtc<'d, T> {
    ...
    pub fn new_for_freq(rtc: Peri<'d, T>, freq_hz: u32) -> Result<Self, PrescalerOutOfRangeError> {
        let prescaler = (32_768_000 / freq_hz).saturating_sub(1);
    ...
    pub fn disable(&mut self) {
        T::regs().tasks_stop().write_value(0);
    }

    /// Enables interrupts for the given [RtcInterrupt] source.
    ///
    ...
    /// Disables interrupts for the given [RtcInterrupt] source.
    ///
